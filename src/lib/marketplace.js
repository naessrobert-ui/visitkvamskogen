...
const MARKETPLACE_FIELDS = 'id,title,category,listing_type,price,area,description,contact_name,expires_at,status,is_featured,created_at,marketplace_listing_images(id,image_path,alt_text,sort_order)';
