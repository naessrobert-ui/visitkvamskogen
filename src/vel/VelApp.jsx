...
import {
  ...
  signOutVel, updateVelCase, updateVelMember,
} from './velApi.js';
    ...
    <div className="vel-app">
      ...
      <div className="vel-layout">
        ...
        <main className="vel-main">
          ...
          {view === 'meeting' && selectedMeeting && <MeetingDetail meeting={selectedMeeting} cases={maps.casesByMeeting.get(selectedMeeting.id) || []} maps={maps} onBack={() => navigate('meetings')} onOpenCase={openCase} onNewCase={() => setModal({ type: 'case', meetingId: selectedMeeting.id })} />}
        </main>
      </div>
      ...
      {modal?.type === 'meeting' && <Modal title="Nytt styremøte" onClose={() => setModal(null)}><MeetingForm onClose={() => setModal(null)} onSubmit={handleCreateMeeting} /></Modal>}
