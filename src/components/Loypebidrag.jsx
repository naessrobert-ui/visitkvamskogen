  ...
  <section className="loypebidrag-page">
    <div className="container loypebidrag-shell">
      <article className="loypebidrag-article">
        ...
        />
        <div className="eyebrow winter"><span className="dot"/>Løypebidrag</div>
      ...
      <aside className="loypebidrag-card">
        <h2>Støtt løypene</h2>
        <p>Bidraget går til preparering, vedlikehold og tiltak som holder løypenettet i drift.</p>
        <dl>
          <div><dt>Vipps</dt><dd>91705</dd></div>
