  ...
  return (
    <section className="section">
      <div className="container">
        <picture className="route-hero">
          <source srcSet="/assets/photos/lavlandsloypen/hero.avif" type="image/avif"/>
          <source srcSet="/assets/photos/lavlandsloypen/hero.webp" type="image/webp"/>
          <img src="/assets/photos/lavlandsloypen/hero.webp" alt="Kvamskogen — opplev fjellet hele året" loading="eager"/>
        </picture>
